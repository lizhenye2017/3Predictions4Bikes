...
# 特征和目标列 ['workingday', 'hr', 'holiday', 'mnth', 'weekday']
...
# features = ['workingday', 'hr', 'holiday', 'mnth', 'weekday']
target = 'cnt'
...
# 步骤 7: 保存模型和标准化器
torch.save(model.state_dict(), 'nbeats_model_96h.pth')
joblib.dump(scaler, 'scaler_96h.pkl')
joblib.dump(scaler_target, 'scaler_target_96h.pkl')
